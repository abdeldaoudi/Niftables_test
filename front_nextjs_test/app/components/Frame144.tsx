...
export default function Frame144(props : any) {
    ...
    <div className="">
      <div className="lg:flex  mx-auto lg:px-[12rem] lg:py-[2rem]">
        <div className="md:flex-6 md:pr-[2rem]">
          <Typography
            className={`${props.MonumentExtended.className} text-3xl md:w-full pb-[1rem]`}  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}          >
            AI PROSPECTS, MARKET SIZE, AND DEVELOPMENT PACE
          </Typography>
          <Typography
            variant="paragraph"
            className={`${props.satoshiRegular.className} font-normal md:w-full `}  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}          >
